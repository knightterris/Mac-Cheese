  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-stone-900 selection:bg-amber-900/20 selection:text-amber-900 font-sans">
      ...
      <main>
        ...
        {/* 10. Left side "before your experience" right side with multiple question and answer attached drop downs up to 6 drop downs */}
        <FaqSection />
        
      </main>

      {/* 11. Footer section including copyright, location-thailand, company- Chob Siam Co.,Ltd */}
      <Footer />
    </div>
  );
}
