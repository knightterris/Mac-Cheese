...
export const FAQ_ITEMS: FaqItem[] = [
  {
    id: 'faq-1',
    question: 'How long does it take to prepare Firma Italia MAC&CHEESE?',
    answer: 'Cooking takes just 7 to 8 minutes on a standard stovetop. Simply bring 500ml of fresh water to a gentle boil, pour the contents of the pouch, and stir occasionally over medium heat until the sauce transforms into a velvety, creamy glaze and the pasta is tenderly al dente.',
    category: 'Preparation',
  },
  {
    id: 'faq-2',
    question: 'Is MAC&CHEESE authentically 100% made and packaged in Italy?',
    answer: 'Yes, unconditionally. Every box of Firma Italia MAC&CHEESE is produced and packed in Muggiò (Monza and Brianza), Italy by FIRMA ITALIA S.p.A. (founded in 1968), using 100% Italian durum wheat semolina and traditional cheese drying techniques.',
  ...
  },
  {
    ...
    answer: 'Store in a cool, dry ambient pantry at room temperature away from direct sunlight — no refrigeration needed prior to cooking. Each 184g pack makes 2 generous meal portions (approx. 225g each once prepared with water), perfect for sharing or a lavish solo feast.',
